...
def upgrade() -> None:
    ...
    sa.Column('str_name', sa.String(length=255), nullable=False),
    sa.Column('str_description', sa.String(length=255), nullable=False),
    ...
    sa.Column('audit_user_login', sa.String(length=255), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('str_display_name', sa.String(length=255), nullable=False),
    sa.Column('str_username', sa.String(length=255), nullable=False),
    sa.Column('str_password', sa.String(length=255), nullable=False),
    sa.Column('str_email', sa.String(length=255), nullable=False),
    sa.Column('audit_user_ip', sa.String(length=16), nullable=False),
    sa.Column('audit_created_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('audit_updated_on', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('audit_user_login', sa.String(length=255), nullable=False),
